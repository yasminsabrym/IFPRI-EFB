      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="bg-white text-black max-w-[95vw] sm:max-w-[600px] min-h-[300px]">
          ...
          {chartData && chartData.length > 0 ? (
            ...
            <p>
              {/* INSERT HERE TEXT UNDER EACH BARCHART */}
              {selectedNode === 'Baseline (Birth)'
                ? 'This is the text chart for the bar chart 1'
                : selectedNode === '2 Months'
                  ? 'This is the text chart for the bar chart 2'
                  : selectedNode === '4 Months'
                    ? 'This is the text chart for the bar chart 3'
                    : 'This is the default text for the bar chart'}
            </p>
            </>
          ) : (
