  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-md md:max-w-xl">
        ...
        <motion.div
          className="h-64 md:h-80 bg-gray-200 rounded-lg mb-4 flex items-center justify-center"
          initial={{scale: 0}}
          animate={{scale: 1, transition: {type: 'spring', stiffness: 100, damping: 20, delay: 0.7}}}
        >
